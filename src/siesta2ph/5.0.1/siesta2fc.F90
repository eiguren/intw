...
contains
  ...
  subroutine write_fc_phonopy(filename)
    ...
    !
    use siesta2ph_io, only:   use siesta2ph_system, only: nat
  ...
  subroutine compute_force_constants()
    ...
    !
    use siesta2ph_io, only: hdir, lpm
  ...
  subroutine dynamical_matrix()
    ...
    ! TODO: Add description
    !
    use siesta2ph_io, only: r1, nr2, nr3, irreducible_q
  ...
  subroutine phonon_bands()
    ...
    ! TODO: Add description
    !
    use siesta2ph_io, only: path_file, nr1, nr2, nr3
