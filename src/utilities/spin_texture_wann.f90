  ...
  if (kb_2_Rw_spin) then
     ...
     if (kb_spin) then !We calculate
        ...
        do ik=1,nkmesh
           ...
           !
           if (abs(QE_eig_k(1)-QE_eig_k(2)).lt.0.02) then
              !
...
!              spin_kb(ik,2,:)=cmplx_0
           ...
           !
           if (abs(QE_eig_k(3)-QE_eig_k(4)).lt.0.01) then
              !
...
!              !
!              spin_kb(ik,1,3)=cmplx_0
!              spin_kb(ik,2,3)=cmplx_0
!              !
!           endif
!              !
!           if (abs(QE_eig_k(3)-QE_eig_k(4)).lt.0.01) then
!              !
!              spin_kb(ik,3,3)=cmplx_0
!              spin_kb(ik,4,3)=cmplx_0
!              !
!           endif
!           !
