program imselfen2reselfen_eiguren_goiricelaya
  ...
  real(dp) :: trshld,e_min,e_max,d_e
  ...
  do ik=1,nkk
     ...
     !
     if (ik<10) then
        open(unit=10*ik+1,file=trim(trim(mesh_dir)//trim('im_selfen_KM_up_q_500/im_selfen_')//trim(ik_loc1)//trim('.bin')),form='unformatted')
     elseif (ik<100) then
        open(unit=10*ik+1,file=trim(trim(mesh_dir)//trim('im_selfen_KM_up_q_500/im_selfen_')//trim(ik_loc2)//trim('.bin')),form='unformatted')
     elseif (ik<1000) then
        open(unit=10*ik+1,file=trim(trim(mesh_dir)//trim('im_selfen_KM_up_q_500/im_selfen_')//trim(ik_loc3)//trim('.bin')),form='unformatted')
     elseif (ik<10000) then
        open(unit=10*ik+1,file=trim(trim(mesh_dir)//trim('im_selfen_KM_up_q_500/im_selfen_')//trim(ik_loc4)//trim('.bin')),form='unformatted')
     endif
     !
     do ipts=1,epts
        !
     ...
     close(10*ik+1)
     !
     call imselfen2reselfen_t0(epts,e_min,e_max,d_e,imselfen_w,reselfen_w)
     !
     if (ik<10) then
        open(unit=10*ik+1,file=trim(trim(mesh_dir)//trim('re_selfen_KM_up_q_500/re_selfen_')//trim(ik_loc1)//trim('.bin')),form='unformatted')
        open(unit=10*ik+2,file=trim(trim(mesh_dir)//trim('re_selfen_KM_up_q_500/re_selfen_')//trim(ik_loc1)//trim('.dat')))
     elseif (ik<100) then
        open(unit=10*ik+1,file=trim(trim(mesh_dir)//trim('re_selfen_KM_up_q_500/re_selfen_')//trim(ik_loc2)//trim('.bin')),form='unformatted')
        open(unit=10*ik+2,file=trim(trim(mesh_dir)//trim('re_selfen_KM_up_q_500/re_selfen_')//trim(ik_loc2)//trim('.dat')))
     elseif (ik<1000) then
        open(unit=10*ik+1,file=trim(trim(mesh_dir)//trim('re_selfen_KM_up_q_500/re_selfen_')//trim(ik_loc3)//trim('.bin')),form='unformatted')
        open(unit=10*ik+2,file=trim(trim(mesh_dir)//trim('re_selfen_KM_up_q_500/re_selfen_')//trim(ik_loc3)//trim('.dat')))
     elseif (ik<10000) then
        open(unit=10*ik+1,file=trim(trim(mesh_dir)//trim('re_selfen_KM_up_q_500/re_selfen_')//trim(ik_loc4)//trim('.bin')),form='unformatted')
        open(unit=10*ik+2,file=trim(trim(mesh_dir)//trim('re_selfen_KM_up_q_500/re_selfen_')//trim(ik_loc4)//trim('.dat')))
     endif
     !
     do ipts=1,epts
        !
        write(10*ik+1) reselfen_w(ipts)
        write(10*ik+2,'(100f16.8)') e_min+d_e*(ipts-1),reselfen_w(ipts)
        !
     enddo
     !
     close(10*ik+1)
...
end program imselfen2reselfen_eiguren_goiricelaya
