...
!           sqrt(qpoint_cart(1)**2+qpoint_cart(2)**2+qpoint_cart(3)**2),eigen(:,iqpt)
     ...
     do imode=1,3*nat
        ...
        if (w2(imode).gt.0.d0) then
           w22(imode)=sqrt(abs(w2(imode)))
        else
           w22(imode)=-sqrt(abs(w2(imode)))
        endif
           w22(imode)=w22(imode)*0.001d0
        !
     enddo !imode
     !
     if (iq.lt.168) then
        ...
        write(1315,'(i10,3f8.5,f12.6,100f15.8)') iq,qpoint(:), &
           sqrt(qpoint_cart(1)**2+qpoint_cart(2)**2+qpoint_cart(3)**2),w22(:)
        !
     elseif (iq.gt.167.and.iq.lt.251) then
        !
        write(1315,'(i10,3f8.5,f12.6,100f15.8)') iq,qpoint(:), &
           1.d0-sqrt(qpoint_cart(1)**2+qpoint_cart(2)**2+qpoint_cart(3)**2-1.d0/3.d0),w22(:)
        !
     elseif (ik.gt.250) then
        !
        write(1315,'(i10,3f8.5,f12.6,100f15.8)') iq,qpoint(:), &
           1.d0+sqrt(1.d0/3.d0)-sqrt(qpoint_cart(1)**2+qpoint_cart(2)**2+qpoint_cart(3)**2),w22(:)
        !
     endif
     !
     if (iq.lt.168) then
