program fc
  ...
  !================================================================================
  !
  ! read scf file of Fe_1 displaced on x direction
  atm = 273 ! number of the moved atom
  dir = 1 ! direction in which the atom has been moved
  dx = 0.0001*alat ! displacement of the atom
  scf_fe=trim(mesh_dir_fe)//'Fe_1_x/mgo-ag100.scf.out'
  ...
  dx = 0.0001*alat ! displacement of the atom
  scf_fe=trim(mesh_dir_fe)//'Fe_1_y/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_p)
  scf_fe=trim(mesh_dir_fe)//'Fe_1_-y/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_m)
  !
  ! add this to the FC matrix
  do ia=1,nat
  ...
  dx = 0.0001*alat ! displacement of the atom
  scf_fe=trim(mesh_dir_fe)//'Fe_1_z/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_p)
  scf_fe=trim(mesh_dir_fe)//'Fe_1_-z/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_m)
  !
  ! add this to the FC matrix
  do ia=1,nat
  ...
  enddo
  !
  ! ! read scf file of Fe_2 displaced on x direction
  ! atm = 274 ! number of the moved atom
  ! dir = 1 ! direction in which the atom has been moved
  ! dx = 0.0001*alat ! displacement of the atom
  ! scf_fe=trim(mesh_dir_fe)//'Fe_2_x/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_p)
  ! scf_fe=trim(mesh_dir_fe)//'Fe_2_-x/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_m)
  ! !
  ! ! add this to the FC matrix
  ! do ia=1,nat_fe
  ...
  ! enddo
  ! !
  ! ! read scf file of Fe_2 displaced on y direction
  ! atm = 274 ! number of the moved atom
  ! dir = 2 ! direction in which the atom has been moved
  ! dx = 0.0001*alat ! displacement of the atom
  ! scf_fe=trim(mesh_dir_fe)//'Fe_2_y/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_p)
  ! scf_fe=trim(mesh_dir_fe)//'Fe_2_-y/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_m)
  ! !
  ! ! add this to the FC matrix
  ! do ia=1,nat_fe
  ...
  ! enddo
  ! !
  ! ! read scf file of Fe_2 displaced on z direction
  ! atm = 274 ! number of the moved atom
  ! dir = 3 ! direction in which the atom has been moved
  ! dx = 0.0001*alat ! displacement of the atom
  ! scf_fe=trim(mesh_dir_fe)//'Fe_2_z/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_p)
  ! scf_fe=trim(mesh_dir_fe)//'Fe_2_-z/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_m)
  ! !
  ! ! add this to the FC matrix
  ! do ia=1,nat_fe
  ...
  !
  ! print*, "Fe(273)-O(172)"
  ! print*, frc_fe(1,1,273,172), frc_fe(1,2,273,172), frc_fe(1,3,273,172)
  ! print*, "Fe(273)-O(186)"
  ...
  ! print*, "Fe(273)-Fe(274)"
  ! print*, frc_fe(1,1,273,274), frc_fe(1,2,273,274), frc_fe(1,3,273,274)
  ! !
  ! print*, "Fe(274)-O(172)"
  ! print*, frc_fe(1,1,274,172), frc_fe(1,2,274,172), frc_fe(1,3,274,172)
  ! print*, "Fe(274)-O(186)"
  ! print*, frc_fe(1,1,274,186), frc_fe(1,2,274,186), frc_fe(1,3,274,186)
  ! print*, "Fe(274)-Fe(273)"
  ! print*, frc_fe(1,1,274,273), frc_fe(1,2,274,273), frc_fe(1,3,274,273)
  ! print*, "Fe(274)-Fe(274)"
  ! print*, frc_fe(1,1,274,274), frc_fe(1,2,274,274), frc_fe(1,3,274,274)
  !
  !
  !================================================================================
  ...
  !================================================================================
  !
  ! read scf file of O_1 displaced on x direction
  atm = 172 ! number of the moved atom
  dir = 1 ! direction in which the atom has been moved
  dx = 0.0001*alat ! displacement of the atom
  scf_fe=trim(mesh_dir_fe)//'O_1_x/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_p)
  scf_fe=trim(mesh_dir_fe)//'O_1_-x/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_m)
  !
  ! add this to the FC matrix
  do ia=1,nat
  ...
  enddo
  !
  ! read scf file of O_1 displaced on y direction
  atm = 172 ! number of the moved atom
  dir = 2 ! direction in which the atom has been moved
  dx = 0.0001*alat ! displacement of the atom
  scf_fe=trim(mesh_dir_fe)//'O_1_y/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_p)
  scf_fe=trim(mesh_dir_fe)//'O_1_-y/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_m)
  !
  ! add this to the FC matrix
  do ia=1,nat
  ...
  enddo
  !
  ! read scf file of O_1 displaced on z direction
  atm = 172 ! number of the moved atom
  dir = 3 ! direction in which the atom has been moved
  dx = 0.0001*alat ! displacement of the atom
  scf_fe=trim(mesh_dir_fe)//'O_1_z/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_p)
  scf_fe=trim(mesh_dir_fe)//'O_1_-z/mgo-ag100.scf.out'
  call read_f(scf_fe,nat_fe,f_fe_m)
  !
  ! add this to the FC matrix
  do ia=1,nat
  ...
  enddo
  !
  ! ! read scf file of O_2 displaced on x direction
  ! atm = 186 ! number of the moved atom
  ! dir = 1 ! direction in which the atom has been moved
  ! dx = 0.0001*alat ! displacement of the atom
  ! scf_fe=trim(mesh_dir_fe)//'O_2_x/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_p)
  ! scf_fe=trim(mesh_dir_fe)//'O_2_-x/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_m)
  ! !
  ! ! add this to the FC matrix
  ! do ia=1,nat_fe
  ...
  ! dir = 2 ! direction in which the atom has been moved
  ! dx = 0.0001*alat ! displacement of the atom
  ! scf_fe=trim(mesh_dir_fe)//'O_2_y/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_p)
  ! scf_fe=trim(mesh_dir_fe)//'O_2_-y/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_m)
  ! !
  ! ! add this to the FC matrix
  ! do ia=1,nat_fe
  ...
  ! dir = 3 ! direction in which the atom has been moved
  ! dx = 0.0001*alat ! displacement of the atom
  ! scf_fe=trim(mesh_dir_fe)//'O_2_z/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_p)
  ! scf_fe=trim(mesh_dir_fe)//'O_2_-z/mgo-ag100.scf.out'
  ! call read_f(scf_fe,nat_fe,f_fe_m)
  ! !
  ! ! add this to the FC matrix
  ! do ia=1,nat_fe
  ...
  !
  ! print*, "Fe(172)-O(172)"
  ! print*, frc_fe(1,1,172,172), frc_fe(1,2,172,172), frc_fe(1,3,172,172)
  ! print*, "Fe(172)-O(186)"
  ! print*, frc_fe(1,1,172,186), frc_fe(1,2,172,186), frc_fe(1,3,172,186)
  ! print*, "Fe(172)-Fe(273)"
  ! print*, frc_fe(1,1,172,273), frc_fe(1,2,172,273), frc_fe(1,3,172,273)
  ! print*, "Fe(172)-Fe(274)"
  ! print*, frc_fe(1,1,172,274), frc_fe(1,2,172,274), frc_fe(1,3,172,274)
  ! !
  ! print*, "Fe(186)-O(172)"
  ! print*, frc_fe(1,1,186,172), frc_fe(1,2,186,172), frc_fe(1,3,186,172)
  ! print*, "Fe(186)-O(186)"
  ...
  ! print*, "Fe(186)-Fe(274)"
  ! print*, frc_fe(1,1,186,274), frc_fe(1,2,186,274), frc_fe(1,3,186,274)
  !
  !
  !================================================================================
  !   Apply symmetries
  !================================================================================
  !
  allocate(tau_cryst(3,nat_fe), rtau_cryst(3,nsym,nat_fe), rtau(3,nsym,nat_fe), rtau_index(nat_fe,nsym))
  !
  call rot_atoms(nat_fe,nsym, tau_fe)
  !
