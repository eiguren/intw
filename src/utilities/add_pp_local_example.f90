program add_pp_local_example
  !
  ! Example program to add the derivative of the local part of the PP
  ! to the induced variation of the potential.
  ! In this example I calculate the variation of the local part of the PP
  ! for graphene. I want to test some things:
  !  - 1st: Study the way to calculate the change pf potential using gamma_only.
  !  - 2nd: Compare different methods to do this.
  !
  ...
  ! mesh_dir = '/home/haritz/Kalkuluak/Probak/grafenoa/UC/'
  prefix = 'g'
  nk1 = 1
  nk2 = 1
  nk3 = 1
...
end program add_pp_local_example
