...
real(dp),allocatable:: kpoints_QE(:,:), kmesh(:,:), qmesh(:,:)
...
!================================================================================
! Build the kmesh and qmesh corresponding to the parameters in the input file 
!================================================================================
nkmesh = nk1*nk2*nk3
...
!================================================================================
!      23 06 2014 Test if phonon nq1 nq2 nq3 is conmensurate with elektron  nk1 nk2 nk3
!================================================================================
...
if (.not.conmesurate_and_coarser (nk1, nk2, nk3, nq1, nq2, nq3)) then 
        ...
        write(*,20) '|       - conmesurate of the k grid does not contain|'
