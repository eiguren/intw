...
!  use intw_tests
  ...
  use intw_reading, only : nbands,ngm,gvec, nsym, can_use_TR
  use intw_reading, only: nkpoints_QE, spinorb_mag, noncolin, nspin,get_ngm, get_gvec
  ...
  use intw_reading, only: deallocate_reading_variables
